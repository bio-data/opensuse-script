...
echo "+------------------------------------------------------------------+"
sudo zypper -n remove empathy gnome-nibbles gnome-robots gnome-tetravex four-in-a-row liferea five-or-more gnome-klotski tali gnome-sudoku swell-foop lightsoff gnome-mines gnome-mahjongg bijiben gnome-software evolution aisleriot iagno xboard gnuchess quadrapassel
